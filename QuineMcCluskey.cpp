...
#include <stdlib.h>
#include <math.h>
#define opFile "C:\\Users\\aabhyudai\\Desktop\\QM\\7.txt"
int i, j, temp, NumberOfVariable, NumberOfAllMinterm, NumberOfDontCare, NumberOfEPI = 0,
                                                                        NumberOfRemainingMT, NumberOfRemainingPI, NumberOfPI = 0, PotEPINo = 0, NumberOfPossibleEPI = 1, MinimumNo = 0,
                                                                        int *MintermIndicesDecimal, *MintermIndicesDecimal_DontCare, **Minterm_Binary, ****Column, **PI_Index,
                                                                        **EPI_Index, *NumberCounter, *ReducedPIChart_X, **ReducedPIChart_Y, **ReducedPIChart, *For, **Potential_EPI, *void DecimalToBinary();
...
int main()
{
 ...
 fprintf(fp,"Number of minterms: %d\n",NumberOfAllMinterm);
 ...
 fprintf(fp,"Number of dont'tcare: %d\n",NumberOfDontCare);
 while(NumberOfDontCare>=NumberOfAllMinterm || NumberOfDontCare<0)
 {
 printf("The number of Don't-Care minterms cannot be greater than the number of all minterms nor smaller
 ...
 fprintf(fp,"___________________MINTERMS_____________________\n");
 ...
 {
        fprintf(fp, "___________________DON'T CARE_____________________\n");
        ...
        for (i = 0; i < NumberOfDontCare; i++)
        {
            ...
            fprintf(fp, ">> %d\n", MintermIndicesDecimal_DontCare[i]);
 ...
 NumberCounter[Column[PI_Index[j][0]][PI_Index[j][1]][PI_Index[j][2]][NumberOfVariable+3+PI_Index[j][0]+l
 NumberOfEPI++;
 ...
 {
 if(NumberCounter[Column[PI_Index[i][0]][PI_Index[i][1]][PI_Index[i][2]][NumberOfVariable+3+PI_Index[i][0]+j
 {
